...
/// <summary>
/// Canvas上のPanel(RectTransform)を「ウィンドウ矩形」として扱うためのコンポーネント。
/// RectはUnityのスクリーン座標(左下原点, px)で返します。
/// </summary>
[DisallowMultipleComponent]
public sealed class CanvasWindowRect : MonoBehaviour
{
